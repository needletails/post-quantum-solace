...
public enum PQSSessionConstants: Sendable {
    ...
    ///
    /// Schema 2 (PQS 4.0): encrypted-retry `TransportEvent` cases are gone; leftover
    /// retry jobs are deleted on unlock; reestablishment wire fallbacks are rejected.
    public static let sessionSchemaVersion: Int = 2
}
