...
public actor SessionCache: PQSSessionStore {
    ...
    func setLocalDeviceConfiguration(_ configuration: Data) async throws {
        do {
            ...
            self.localDeviceConfiguration = configuration
        } catch {
