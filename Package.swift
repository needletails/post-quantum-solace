...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "git@github.com:needletails/double-ratchet-kit.git", .upToNextMajor(from: "1.0.3")),
        .package(url: "git@github.com:needletails/needletail-crypto.git", .upToNextMajor(from: "1.0.12")),
